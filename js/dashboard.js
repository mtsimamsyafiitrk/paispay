...
function renderDashboard() {
  ...
  document.getElementById('statGrid').innerHTML = `
    <div class="stat-card green"><div class="stat-label">Total Santri</div><div class="stat-value">${totalSiswa}</div><div class="stat-sub">Terdaftar TA 2025/2026</div><div class="stat-icon">🎓</div></div>
